...
DEFINE_int32(n,100000,"read vector num from train file");
...
int main(int argc, char** argv) {
    ...
    faiss::kmeans_clustering(d,n,k,features.get(),coarse_centroids.get());
    ...
    faiss::kmeans_clustering(d,n,k,residuals.get(),residual_centroids.get());
    ...
    //write to fvecs
    gnoimi::fvecs_write(coarseFile_name.c_str(),d,k,coarse_centroids.get());
    gnoimi::fvecs_write(fineFile_name.c_str(),d,k,residual_centroids.get());
