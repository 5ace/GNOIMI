...
./searchGNOIMI -threadsCount=50 --residual_opq=true --L=32 --model_prefix=./mmu0.5b/learn_from_yael_k4096_residual_opq_ --index_prefix=./mmu0.5b/index_k4096_0.5b_residual_opq_ --query_filename=mmu0.5b/mmu0.5b_query.99w.fvecs --base_file=mmu0.5b/mmu0.5b_base.fvecs --groud_truth_file=mmu0.5b/mmu0.5b_groudtruth_0.5b.ivecs --N=0 --neighborsCount=200 --queriesCount=10000 --make_index=true &>log.index.mmu0.5b.gnoimi.0.5b
